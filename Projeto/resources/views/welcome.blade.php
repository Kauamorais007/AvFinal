...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Shauh</a></h1>
  ...
  <section id="hero">
    <div class="hero-container">
      <h1>Bem vindo a melhor loja de calçados da america latina</h1>
      <h2>Aqui você encontrara uma enorme variedade de modelos, cores e tamanhos para todos os estilos e gostos </h2>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <h2>Sobre </h2>
            <h3>Site exprimental criado para aprendizagem sem fins financeiros</h3>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
            Nosso principal objetivo é desenvolver habilidades em programação web, incluindo front-end e back-end.</p>
            <p>Explorar conceitos avançados de design de interfaces e experiência do usuário (UX).</p>
            <p>Experimentar técnicas de segurança cibernética e boas práticas de desenvolvimento seguro.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Linguagens: HTML5, CSS3, JavaScript, PHP</li>
              <li><i class="ri-check-double-line"></i> Bancos de dados: MySQL, PhpAdmin</li>  
            </ul>
          </div>
        </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Portifolio de Produtos</h2>
          <p>Aqui estão alguns de nossos produtos</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Esportivo</li>
              <li data-filter=".filter-card">Casual</li>
              <li data-filter=".filter-web">Infantil</li>
            </ul>
          </div>
        </div>
    ...
    <div class="footer-top">
      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-6">
            <h3>Shauh</h3>
            <p>Deseja receber informações em seu email ?</p>
          </div>
        </div>
        ...
        <div class="row footer-newsletter justify-content-center">
          <div class="col-lg-6">
            <form action="" method="post">
              <input type="email" name="email" placeholder="Enter your Email"><input type="submit" value="Enviar">
            </form>
          </div>
        </div>
